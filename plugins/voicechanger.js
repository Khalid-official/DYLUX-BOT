...
if (!/audio/.test(mime)) throw `*[❗𝐈𝐍𝐅𝐎❗] Respond to the audio or voice note which will be modified, using the command ${usedPrefix + command}*`
...
handler.help = ['bass', 'blown', 'deep', 'earrape', 'fast', 'fat', 'nightcore', 'reverse', 'robot', 'slow', 'smooth', ' tupai', 'vibrates'].map(v => v + ' [vn]')
