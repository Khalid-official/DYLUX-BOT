...
} else throw `*[❗𝐈𝐍𝐅𝐎❗] Reply your audio or vn that will be modified, using the command ${usedPrefix + command}*`
} catch(e) {
throw e
}}
...
const getRandom = (ext) => {
return `${Math.floor(Math.random() * 10000)}${ext}`}import { unlinkSync, readFileSync } from 'fs'
import { join } from 'path'
import { exec } from 'child_process'
