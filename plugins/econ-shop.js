...
export default handler//import db from '../lib/database.js'
...
└──────────────`, m)
  } else conn.reply(m.chat, `❎ Sorry, you don't have enough *XP* to buy *${count}* Diamonds💎\n\n You can get *XP* using the commands in the *games and economy menu*`, m)
}
handler.help = ['buy', 'buyall']
handler.tags = ['econ']
handler.command = ['buy', 'buyall'] 
